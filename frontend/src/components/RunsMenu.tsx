      ...
      <DropdownMenuContent align="end" className="w-72">
        ...
        {runs.map((r) => (
          ...
          >
            ...
            <span className="min-w-0 flex-1 truncate">{r.scenario}</span>
            {r.verdict && (
              <span className={cn("shrink-0 rounded px-1 py-0.5 text-[9px] font-semibold uppercase",
                r.verdict === "pass" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"
                : r.verdict === "fail" ? "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300"
