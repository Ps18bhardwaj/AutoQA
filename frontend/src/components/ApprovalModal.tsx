          ...
          <AlertDialogDescription asChild>
            <div className="space-y-3 pt-1 text-left text-foreground">
              <p className="text-sm text-muted-foreground">
                The agent wants to <strong className="text-foreground">submit a form</strong> —
                review (and optionally edit) the arguments before allowing it. AutoQA never
                submits without your approval.
              </p>

              {action.screenshotUrl && (
                <img
                  src={screenshotSrc(action.screenshotUrl)}
                  alt="what the agent is about to submit"
